        ...
        <div class="row">
          <div class="col-lg-6 col-md-6">
            <div class="about-item pr-3 mb-5 mb-lg-0">
              <span class="h6 text-color"> Who Are We? </span>
              <h2 class="mt-3 mb-4 position-relative content-title">
                We are dynamic team of creative people
              </h2>
              <p class="mb-5">
                A local visual communications agency, that is capable of
                creating brands, illustra tions, advertisements, social media
                posts, anything related to graphic design and events.
              </p>
              <p>
                We also represent one of the best local experienced interior
                designers and wood manufacturing companies that are
                specialized with modern furniture, kitchens and booths
              </p>
              <p>
                Laguna is able to provide the visual design work for any
                business, in a timely manner. We pride ourselves on creating
                the most innovative designs while provid ing truly superior
                customer services.
              </p>
              <p>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="about-info-item mb-4 mb-lg-0">
              ...
              <p>
                Creating unique brands, illustrations, advertisements, social
                media posts and anything related to graphic design.
                <br /><br />
          ...
          <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="about-info-item mb-4 mb-lg-0">
              ...
              <p>Making branding and art world’s colorful escape .</p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="about-info-item mb-4 mb-lg-0">
